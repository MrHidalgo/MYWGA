...
function imageSprites(taskName) {
    ...
    gulp.task(taskName, function() {
        ...
        src             = './src/icons/*.png';
        spImgPath       = '../img/sprite_MYWGA.png';
        retinaspImgPath = '../img/sprite_MYWGA@2x.png';
        destImg         = './dist/img/';
        ...
        var spriteData = gulp.src(src)
            ...
            .pipe(spritesmith(
                {
                    imgName         : 'sprite_MYWGA.png',
                    imgPath         : spImgPath,
                    retinaImgPath   : retinaspImgPath,
                    cssName         : '_sprite_MYWGA.scss',
                    retinaSrcFilter :
                        [
                            './src/icons/*@2x.png'
                        ],
                    retinaImgName   : 'sprite_MYWGA@2x.png',
                    algorithm       : 'top-down',
                    algorithmOpts   : {
                        sort : false
                    },
